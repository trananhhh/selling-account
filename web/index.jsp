...
--%> <%@page import="model.Item"%> <%@page import="java.util.ArrayList"%>
<%@page import="java.util.List"%> <%@page import="model.Plan"%> <%@page
            ...
            <header class="vh-100 row justify-content-center" id="header">
                <div class="container px-5">
                    <nav id="navbar">
                        ...
                        <a id="login-btn" class="btn btn-outline-secondary"
